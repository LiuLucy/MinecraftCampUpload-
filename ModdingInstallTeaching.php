...
<html>
  ...
  <body>
    ...
    <div id="doc" class="markdown-body container-fluid" style="position: relative;"><h1 id="Modding營-安裝教學" style=""><a class="anchor hidden-xs" href="#Modding營-安裝教學" title="Modding營-安裝教學"><span class="octicon octicon-link"></span></a>Modding營 安裝教學</h1><blockquote>
<p>只能在Windows系統執行喔，這個安裝包是相對應Minecraft 1.11.2版本64位元的，32位元電腦或想要更新的版本請自<a href="https://mcreator.net/" target="_blank">官網</a>下載</p>
</blockquote><h3 id="1-下載安裝包-下載連結" style=""><a class="anchor hidden-xs" href="#1-下載安裝包-下載連結" title="1-下載安裝包-下載連結"><span class="octicon octicon-link"></span></a>1. 下載安裝包 <a href="https://1drv.ms/u/s!AkIWKerRKAMfg894v1R9-KUI3deecQ" target="_blank">下載連結</a></h3><pre><code>a. 安裝包下載後解壓縮在桌面上即可
b. 解壓縮後會看到三個資料夾，"MCEdit"、"Pylo"、"Techne"
</code></pre><h3 id="2-MCEdit0" style=""><a class="anchor hidden-xs" href="#2-MCEdit0" title="2-MCEdit0"><span class="octicon octicon-link"></span></a>2. MCEdit</h3><pre><code>a.地圖編輯器，可用來做大量編輯複製
</code></pre><h3 id="3-Pylo" style=""><a class="anchor hidden-xs" href="#3-Pylo" title="3-Pylo"><span class="octicon octicon-link"></span></a>3. Pylo</h3><pre><code>a.上課的主要軟體-Mcreator的資料夾
b.進入後雙擊"MCreator.exe"
c.第一次開啟可能需要一點時間，請等候...
</code></pre><h3 id="4-Techne" style=""><a class="anchor hidden-xs" href="#4-Techne" title="4-Techne"><span class="octicon octicon-link"></span></a>4. Techne</h3><pre><code>a.製作Mob 模型的軟體
b.裡面很多檔案都不要理，只要雙擊"Techne.exe"即可
</code></pre><h3 id="5-最後一步驟" style=""><a class="anchor hidden-xs" href="#5-最後一步驟" title="5-最後一步驟"><span class="octicon octicon-link"></span></a>5. 最後一步驟</h3><pre><code>a.將製作完的模組匯出
b.照著以下影片教學放到Minecraft中，也可把模組給別人安裝！
</code></pre><p><a href="http://www.youtube.com/watch?v=fkOR3XYXuCE" title="模組匯入使用教學" target="_blank"><img src="http://img.youtube.com/vi/fkOR3XYXuCE/0.jpg" alt="使用模組"></a></p></div>
    <div class="ui-toc dropup unselectable hidden-print" style="display:none;">
        <div class="pull-right dropdown">
            ...
            <ul id="ui-toc" class="ui-toc-dropdown dropdown-menu" aria-labelledby="tocLabel">
                <div class="toc"><ul class="nav"><li class=""><a href="#Modding營-安裝教學">Modding營 安裝教學</a><ul class="nav"><li class=""><a href="#1-下載安裝包-下載連結">1. 下載安裝包 下載連結</a></li><li class=""><a href="#2-MCEdit0">2. MCEdit</a></li><li class=""><a href="#3-Pylo">3. Pylo</a></li><li><a href="#4-Techne">4. Techne</a></li><li class=""><a href="#5-最後一步驟">5. 最後一步驟</a></li></ul></li></ul></div><div class="toc-menu"><a class="expand-toggle" href="#">Expand all</a><a class="back-to-top" href="#">Back to top</a><a class="go-to-bottom" href="#">Go to bottom</a></div>
            </ul>
        </div>
    </div>
