...
<html>
  <head>
    ...
    <style>
        ...
        .markdown-body[lang^=ja] {
            font-family: -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Helvetica, Arial, Hiragino Kaku Gothic Pro, \\30D2\30E9\30AE\30CE\89D2\30B4 Pro W3, Osaka, Meiryo, \\30E1\30A4\30EA\30AA, MS Gothic, "\FF2D\FF33   \30B4\30B7\30C3\30AF", sans-serif
        }
        ...
        .markdown-body[lang=zh-tw] {
            font-family: -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Helvetica, Arial, PingFang TC, Microsoft JhengHei, \\5FAE\8EDF\6B63\9ED1, sans-serif
        }
        ...
        .markdown-body[lang=zh-cn] {
            font-family: -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Helvetica, Arial, PingFang SC, Microsoft YaHei, \\5FAE\8F6F\96C5\9ED1, sans-serif
        }
  ...
  <body>
    ...
    <div id="doc" class="markdown-body container-fluid" style="position: relative;"><h1 id="Python營-安裝教學" style=""><a class="anchor hidden-xs" href="#Python營-安裝教學" title="Python營-安裝教學"><span class="octicon octicon-link"></span></a>Python營 安裝教學</h1><h3 id="1-安裝Anaconda-詳細圖文教學" style=""><a class="anchor hidden-xs" href="#1-安裝Anaconda-詳細圖文教學" title="1-安裝Anaconda-詳細圖文教學"><span class="octicon octicon-link"></span></a>1. 安裝Anaconda <a href="https://1drv.ms/b/s!AkIWKerRKAMfg893D0VEYBNO-X_HEA" target="_blank">詳細圖文教學</a></h3><pre><code>a. 在google搜尋“Anaconda”
b. 到Anaconda首頁點選"Download"
c. 選擇3.6版本下載
</code></pre><h3 id="2-安裝JDK8" style=""><a class="anchor hidden-xs" href="#2-安裝JDK8" title="2-安裝JDK8"><span class="octicon octicon-link"></span></a>2. 安裝JDK8</h3><pre><code>a.[JDK8下載連結](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html)
b.找到Java SE Development Kit 8u162
c.選取Accept License Agreement
d.選擇版本下載安裝
</code></pre><h3 id="3-安裝伺服器" style=""><a class="anchor hidden-xs" href="#3-安裝伺服器" title="3-安裝伺服器"><span class="octicon octicon-link"></span></a>3. 安裝伺服器</h3><pre><code>a.Windows電腦安裝包:https://1drv.ms/u/s!AkIWKerRKAMfg895X_80bgY0qQRVnA
b.Mac電腦安裝包:https://1drv.ms/u/s!AkIWKerRKAMfg896a3a4hHFR4rW4XQ
c.下載後解壓縮
</code></pre><h3 id="4-大功告成囉" style=""><a class="anchor hidden-xs" href="#4-大功告成囉" title="4-大功告成囉"><span class="octicon octicon-link"></span></a>4. 大功告成囉</h3><pre><code>a.接下來就跟上課一樣囉
b.開啟伺服器
    Windows執行StartServer.bat
    Mac執行server資料夾中的start.command
c.開啟Spyder寫程式，程式存在“魔法世界”中</code></pre><div class="resize-sensor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; z-index: -1; visibility: hidden;"><div class="resize-sensor-expand" style="position: absolute; left: 0; top: 0; right: 0; bottom: 0; overflow: hidden; z-index: -1; visibility: hidden;"><div style="position: absolute; left: 0px; top: 0px; transition: all 0s ease 0s; width: 100000px; height: 100000px;"></div></div><div class="resize-sensor-shrink" style="position: absolute; left: 0; top: 0; right: 0; bottom: 0; overflow: hidden; z-index: -1; visibility: hidden;"><div style="position: absolute; left: 0; top: 0; transition: 0s; width: 200%; height: 200%"></div></div></div></div>
    <div class="ui-toc dropup unselectable hidden-print" style="display:none;">
        <div class="pull-right dropdown">
            ...
            <ul id="ui-toc" class="ui-toc-dropdown dropdown-menu" aria-labelledby="tocLabel">
                <div class="toc"><ul class="nav"><li class=""><a href="#Python營-安裝教學">Python營 安裝教學</a><ul class="nav"><li><a href="#1-安裝Anaconda-詳細圖文教學">1. 安裝Anaconda 詳細圖文教學</a></li><li><a href="#2-安裝JDK8">2. 安裝JDK8</a></li><li><a href="#3-安裝伺服器">3. 安裝伺服器</a></li><li><a href="#4-大功告成囉">4. 大功告成囉</a></li></ul></li></ul></div><div class="toc-menu"><a class="expand-toggle" href="#">Expand all</a><a class="back-to-top" href="#">Back to top</a><a class="go-to-bottom" href="#">Go to bottom</a></div>
            </ul>
        </div>
    </div>
    <div id="ui-toc-affix" class="ui-affix-toc ui-toc-dropdown unselectable hidden-print" data-spy="affix" style="top:30px;display:none;"  >
        <div class="toc"><ul class="nav"><li class=""><a href="#Python營-安裝教學">Python營 安裝教學</a><ul class="nav"><li><a href="#1-安裝Anaconda-詳細圖文教學">1. 安裝Anaconda 詳細圖文教學</a></li><li><a href="#2-安裝JDK8">2. 安裝JDK8</a></li><li><a href="#3-安裝伺服器">3. 安裝伺服器</a></li><li><a href="#4-大功告成囉">4. 大功告成囉</a></li></ul></li></ul></div><div class="toc-menu"><a class="expand-toggle" href="#">Expand all</a><a class="back-to-top" href="#">Back to top</a><a class="go-to-bottom" href="#">Go to bottom</a></div>
    </div>
